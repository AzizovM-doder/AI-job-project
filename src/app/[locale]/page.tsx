    ...
    <div className="flex flex-col space-y-24 py-16">
      ...
      <section className="text-center space-y-8">
        <Container className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[1.05] uppercase mt-8">
            {t('hero.headline1')}{' '}
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mt-8">
            {t('hero.description')}
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 mt-8">
      ...
      <section className="w-full">
        <Container className="max-w-2xl">
          <div className="grid grid-cols-3 gap-0 w-full border border-border rounded-lg overflow-hidden">
            {[
